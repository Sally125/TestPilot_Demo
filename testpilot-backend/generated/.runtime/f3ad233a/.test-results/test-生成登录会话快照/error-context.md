...
- Location: testpilot-backend\generated\.runtime\f3ad233a\test.spec.ts:3:5
...
> 15 |   await page.waitForURL('http://localhost:3001/dashboard**', { timeout: 15000 });
  ...
  16 | 
  17 |   // 5. 保存会话快照
  18 |   await page.context().storageState({ path: 'E:/hkx_project/TestPilot/testpilot-backend/data/storage-states/3/profile-9.json' });
  19 | });
  20 | 
```